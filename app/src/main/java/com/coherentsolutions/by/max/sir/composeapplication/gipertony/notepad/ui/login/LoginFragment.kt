...
import com.coherentsolutions.by.max.sir.composeapplication.gipertony.notepad.databinding.ActivityLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.sign_up_login_menu_item -> findNavController().navigate(LoginFragmentDirections.actionLoginFragmentToSignUpFragment())
        }
